...
public class LoanCalculator extends JFrame {
    ...
    private void validateInputs(double principal, double rate, int term) {
        if (principal > 1_000_000_000) throw new IllegalArgumentException("Maximum loan amount is $1 billion");
        if (rate < 0.01 || rate > 25) throw new IllegalArgumentException("Rate must be between 0.01% and 25%");
        if (term > 50) throw new IllegalArgumentException("Maximum term is 50 years");
    }
